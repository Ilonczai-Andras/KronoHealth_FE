import { Component, Input, ElementRef, Renderer2, OnChanges, inject } from '@angular/core';
import {
  Activity, Moon, Heart, Zap, TrendingUp, TrendingDown, Minus,
  ArrowRight, Mail, Lock, Eye, EyeOff, User, Bell, Search, ChevronDown,
  LayoutDashboard, FlaskConical, Plug, Settings, LogOut, Upload, FileText,
  Link, Link2Off, RefreshCw, CheckCircle, AlertTriangle, Watch, Flame,
  Droplets, Microscope, Shield, Check, ChevronRight, LucideIconData
} from 'lucide-angular';
