  ...
  // ── Protected routes (with dashboard layout) ──────────────────────────────
  {
    ...
    children: [
      ...
      },
      {
        path: 'biomarker-lab',
        loadComponent: () =>
          import('./features/biomarker-lab/biomarker-lab.component').then(
            (m) => m.BiomarkerLabComponent,
          ),
        title: 'Biomarker Lab – KronoHealth',
      },
      {
        path: 'biomarker-lab/review/:id',
        loadComponent: () =>
          import('./features/biomarker-lab/lab-review/lab-review.component').then(
            (m) => m.LabReviewComponent,
          ),
        title: 'Lelet átnézése – KronoHealth',
      },
      {
        path: 'integrations',
        loadComponent: () =>
